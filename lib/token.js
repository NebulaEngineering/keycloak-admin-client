...
function getToken() {
  return function getToken(baseUrl, settings) {
    //settings.grant_type = 'password';
    return requestToken(baseUrl, settings);
  };
}

// function getToken1 (client) {
//   return function find (realmName, options) {
//     return new Promise((resolve, reject) => {

// function getToken1(client) {
//   return function getToken1(baseUrl, settings) {
//     //settings.grant_type = 'password';
...
function requestToken(baseUrl, settings) {
  return new Promise((resolve, reject) => {
    ...
    const options = url.parse(
      `${baseUrl}/realms/${settings.realmName}/${tokenUrl}`
    );
